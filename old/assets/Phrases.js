export default {
  phrases: [
    ...
    // "50 years, fucked up with 22 years, but can't get to the 50th anyways",
    "Withdraw the cash!",
    // "What would happen if we cut out all of our capitals going up? nothing special, they'd die, fast.",
    "When police is the one doing all sort of anti-humanity crime, the place is dead. Police? ptssssss!",
    ...
    "Trash belongs to trash can, landfill, or getting recycled at least.",
    ...
    "Had enough with all those garbage politics, and I do not want to mention them ever, again.",
    ...
    "White-colored cat, not white cat. I say that again, IT's White-COLORED cat nOT WHITECAT",
    "How many commits till now?",
    "Navigraph graph graph graph graph graph",
    "Heaven and Er er er er er er ↑er↑ e ↑r ↑↑eeee↑e↑eee↑↑↑↑↑ My guiding STAR",
    "Heaven and BLASTTT",
    "Ottagon, a polygon consists of variable amount of OTTs",
  ],
  m: [
    "Mysterious",
    "Majestic",
